...
const Blog = () => {
    ...
    return (
        <div>
            <div className="bg-[url('https://www.financepoor.com/wp-content/uploads/2021/04/serious-games-and-corporate-training-roi.jpg')] bg-no-repeat bg-cover bg-center py-12 relative">
