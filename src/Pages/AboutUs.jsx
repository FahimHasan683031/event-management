...
const AboutUs = () => {
    return (
        <div>
            <div className="bg-[url('https://www.brinknews.com/wp-content/uploads/2019/12/shutterstock_1031044285.jpg')] bg-no-repeat bg-cover bg-center py-12 -mb-20 relative">
